...
\begin{table}[H]
    ...
    \hline
    0 & 64 & 40 & 6 & 23.44 KB & 0.22 s \\
    1 & 64 & 4044 & 6 & 2.31 MB & 21.74 s \\
    2 & 128 & 388 & 7 & 265.23 KB & 4.77 s \\
    3 & 128 & 365 & 7 & 249.51 KB & 4.49 s \\
    4 & 128 & 315 & 7 & 215.33 KB & 3.87 s \\
    5 & 512 & 460 & 9 & 404.30 KB & 28.26 s \\
    6 & 512 & 64 & 9 & 225.00 KB & 3.93 s \\
    7 & 256 & 819 & 8 & 2.50 MB & 22.64 s \\
    8 & 4096 & 955 & 12 & 4.37 MB & 10.17 min \\
    9 & 8192 & 39 & 13 & 198.05 KB & 53.67 s \\
    10 & 16384 & 1223 & 14 & 6.53 MB & 1.00 h \\
    11 & 512 & 798 & 9 & 6.16 MB & 49.03 s \\
    12 & 512 & 116 & 9 & 917.58 KB & 7.13 s \\
    13 & 524288 & 474 & 19 & 7.73 MB & 16.57 h \\
    14 & 262144 & 1809 & 18 & 27.95 MB & \cellcolor{yellow}\textbf{1.25 d} \\
    15 & 65536 & 734 & 16 & 10.08 MB & 2.73 h \\
    16 & 256 & 4572 & 8 & 55.81 MB & 2.11 min \\
    17 & 512 & 3313 & 9 & 45.50 MB & 3.39 min \\
    18 & 512 & 1283 & 9 & 27.53 MB & 1.31 min \\
    19 & 256 & 6465 & 8 & 123.31 MB & 2.98 min \\
    20 & 512 & 2147 & 9 & 46.07 MB & 2.20 min \\
    21 & 16 & 11905 & 4 & 454.14 MB & 11.43 s \\
    22 & 16 & 7959 & 4 & 303.61 MB & 7.64 s \\
    23 & 512 & 21052 & 9 & 1.76 GB & 21.56 min \\
    24 & 512 & 16928 & 9 & 1.42 GB & 17.33 min \\
    25 & 512 & 10403 & 9 & 892.90 MB & 10.65 min \\
    26 & 524288 & 1375 & 19 & 249.15 MB & \cellcolor{yellow}\textbf{2.00 d} \\
    27 & 8388608 & 4345 & 23 & \cellcolor{yellow}\textbf{953.05 MB} & \cellcolor{yellow}\textbf{4.05 mes} \\
    28 & 16 & 8097 & 4 & 1.21 GB & 7.77 s \\
    29 & 512 & 47096 & 9 & 15.79 GB & 48.23 min \\
    30 & 16777216 & 121144 & 24 & \cellcolor{yellow}\textbf{108.31 GB} & \cellcolor{yellow}\textbf{19.33 años} \\
    \hline
    \end{tabular}
    ...
    Los resultados muestran que, para valores de \(n\) de hasta unos miles (por ejemplo, \(n \le 4096\)) y esfuerzos máximos \(R_{max}\) moderados, el tiempo teórico de ejecución se mantiene en el rango de décimas de segundo a minutos. Sin embargo, al incrementar \(n\) a decenas o centenas de miles y \(R_{max}\) a varios millares, el tiempo crece hasta horas o días

    \begin{itemize}
      \item Para \(n=262\,144\), \(R_{\max}=1809\), \(T\approx1.25\)\,d.
      \item Para \(n=524\,288\), \(R_{\max}=1375\), \(T\approx2\)\,d.
    \end{itemize}

    Finalmente, con \(n\) del orden de \(10^7\)–\(10^8\) y \(R_{max}\) elevado, el tiempo previsto supera meses o incluso años.

    \begin{itemize}
      \item Para \(n=8\,388\,608\), \(R_{\max}=4345\), \(T\approx4.05\)\,meses.
      \item Para \(n=16\,777\,216\), \(R_{\max}=121\,144\), \(T\approx19.33\)\,años.
    \end{itemize}
    ...
    El espacio teórico requerido crece de kilobytes para escenarios pequeños a gigabytes en instancias muy grandes.

    Con \(n \le 512\) y \(R_{max} \le 1000\), la memoria utilizada no supera decenas de megabytes; al aumentar a \(n \sim 10^5\) y \(R_{max} \sim 10^3\), se necesitan decenas o centenas de megabytes; y para \(n \ge 10^7\), el coste espacial supera el gigabyte.

    \begin{itemize}
      \item Para \(n=8\,388\,608\), \(k_{\max}=23\), \(M\approx953\)\,MB.
      \item Para \(n=16\,777\,216\), \(k_{\max}=24\), \(M\approx108.31\)\,GB.
    \end{itemize}

    Aunque la poda de estados ineficientes y la restricción por \(R_{max}\) alivian el consumo, el crecimiento lineal del número de estados impone un límite práctico de memoria para instancias muy grandes.
