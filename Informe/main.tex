...
27 & 23 & 8388608 & 4345   & 26826.10 TB    & 48.61 h \\
28 & 4  & 16      & 8097   & 31.63 MB       & 0.13 s \\
29 & 9  & 512     & 47096  & 423.86 GB      & 48.23 s \\
30 & 25 & 33554432 & 12114 & 1300730.85 TB  & 0.84 mes \\
31 & 30 & 1073741824 & 1000 & 131941395.33 TB & 0.21 años \\
...
\begin{itemize}
  ...
  \item Para \(k=25\), \(n=33\,554\,432\), \(R_{\max}=12114\), el tiempo sube a \(\sim0.84\) meses.
  \item Para \(k=30\), \(n=1.07\times10^9\), \(R_{\max}=1000\), el tiempo estimado es \(\sim0.21\) años.
\end{itemize}
...
\begin{itemize}
  ...
  \item Para \(k=30\), \(n=1.07\times10^9\), el almacenamiento estimado es \(\sim1.32\times10^8\) TB.
\end{itemize}
